...
PlayerData ShowTrajectory::savePlayerData(PlayerObject* player) {
    PlayerData data;
    data.position = player->getPosition();
    data.lastPosition = player->m_lastPosition;
    data.yVelocity = player->m_yVelocity;
    data.rotation = player->getRotation();
    data.isUpsideDown = player->m_isUpsideDown;
    data.isOnSlope = player->m_isOnSlope;
    data.wasOnSlope = player->m_wasOnSlope;
    data.isShip = player->m_isShip;
    data.isBird = player->m_isBird;
    data.isBall = player->m_isBall;
    data.isDart = player->m_isDart;
    data.isRobot = player->m_isRobot;
    data.isSpider = player->m_isSpider;
    data.isSwing = player->m_isSwing;
    data.vehicleSize = player->m_vehicleSize;
    data.playerSpeed = player->m_playerSpeed;
    data.isOnGround = player->m_isOnGround;
    data.isDashing = player->m_isDashing;
    data.gravityMod = player->m_gravityMod;
    data.objectType = player->m_objectType;
    return data;
}

void ShowTrajectory::applyPlayerData(PlayerObject* player, PlayerData data) {
    player->setPosition(data.position);
    player->m_lastPosition = data.lastPosition;
    player->m_yVelocity = data.yVelocity;
    player->setRotation(data.rotation);
    player->m_isUpsideDown = data.isUpsideDown;
    player->m_isOnSlope = data.isOnSlope;
    player->m_wasOnSlope = data.wasOnSlope;
    player->m_isShip = data.isShip;
    player->m_isBird = data.isBird;
    player->m_isBall = data.isBall;
    player->m_isDart = data.isDart;
    player->m_isRobot = data.isRobot;
    player->m_isSpider = data.isSpider;
    player->m_isSwing = data.isSwing;
    player->m_vehicleSize = data.vehicleSize;
    player->m_playerSpeed = data.playerSpeed;
    player->m_isOnGround = data.isOnGround;
    player->m_isDashing = data.isDashing;
    player->m_gravityMod = data.gravityMod;
    player->m_objectType = data.objectType;
}
