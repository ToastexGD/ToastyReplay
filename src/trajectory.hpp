...
public:
    ...
    cocos2d::ccColor4F color1 = ccc4f(0.29f, 0.89f, 0.33f, 1.f);
    cocos2d::ccColor4F color2 = ccc4f(0.51f, 0.03f, 0.03f, 1.f);
    cocos2d::ccColor4F color3 = ccc4f(1.f, 1.f, 0.f, 1.f);
